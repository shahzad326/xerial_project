...
//Import Images
import logolight from "../../assets/images/sibling.jpeg";
import logodark from "../../assets/images/sibling.jpeg";
            ...
            <NavbarBrand className="logo text-uppercase" href="/">
              {this.props.imglight === true ? (
                <img
                  src={logolight}
                  alt=""
                  className="logo-light  bg-transparent"
                  height="22"
                />
              ) : (
                <img
                  src={logodark}
                  alt=""
                  className="logo-dark bg-transparent"
                  height="22"
                />
              )}
            </NavbarBrand>
