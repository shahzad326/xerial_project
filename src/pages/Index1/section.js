...
class Section extends Component {
  ...
  render() {
    ...
    const carouselItemClass = isCalendarOpen
      ? "dynamic-height-carousel auto-height"
                    ...
                    <Col md={12}>
                      <div className="home-content text-right">
                        ...
                        <p className="text-white mt-4 f-18">
                          Vivamus sodales eleifend odio eget mollis Cras
                          consectetur nisi quis pulvinar
                          <br /> laoreet Nulla facilisi Maecenas eget velit
                          laoreet.
                        </p>
                        <div className="pt-4 mt-1">
                          <Link
